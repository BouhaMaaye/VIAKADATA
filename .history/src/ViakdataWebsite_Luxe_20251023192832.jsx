...
const ViakdataWebsite = () => {
  ...
  const navItems = [
    { label: 'Accueil', href: '#home' },                 // ancre sur la page
    { label: 'Expertise IA', to: '/expertise-ia' },      // route SPA
    { label: 'Nos Offres',   to: '/offers' },            // route SPA
    { label: 'Contact',      to: '/contact' },           // route SPA
  ];
  ...
  <div key={i} className="relative">
    {'to' in item ? (
      <Link
        to={item.to}
        className={`font-medium text-base py-2 relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-[#FF5F00] after:transition-all after:duration-300 hover:text-[#FF5F00] hover:after:w-full block transition-colors ${isScrolled ? 'text-[#00204E]' : 'text-white'}`}
      >
        {item.label}
      </Link>
    ) : (
      ...
      <section id="home" className="relative w-full h-screen bg-gradient-to-br from-[#00204E] via-[#001739] to-[#00204E] overflow-hidden">
        ...
        <div className="absolute bottom-8 right-8 md:bottom-12 md:right-12 z-10">
          <img 
            src={import.meta.env.BASE_URL + 'viakadata-fb.png'}
            alt="VIAKDATA" 
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            <div>
              <div className="mb-6">
                <img 
                  src={import.meta.env.BASE_URL + 'Viakdata.jpg'}
                  alt="VIAKDATA" 
