    ...
    <div className="font-sans bg-[#F9FAFB] text-gray-800 overflow-x-hidden">
        ...
        <div className="relative mx-auto max-w-[1400px] w-full">
          <div className="relative w-full h-[70vh] min-h-[600px] rounded-[32px] overflow-hidden shadow-[0_40px_100px_-20px_rgba(0,32,78,0.3)]" style={{ animation: 'heroFadeIn 1s ease 0.2s forwards', opacity: 0 }}>
            ...
            <div className="absolute inset-0 flex flex-col justify-center items-center z-10 text-center px-5">
              ...
              <div style={{ animation: 'ctaFadeIn 1s ease 0.9s forwards', opacity: 0 }}>
                <a href="#savoir" className="inline-flex items-center gap-2.5 px-8 md:px-10 py-4 bg-gradient-to-br from-[#FF5F00] to-[#e55100] text-white rounded-full font-semibold text-base md:text-lg uppercase tracking-wider shadow-[0_10px_30px_rgba(255,95,0,0.3)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_15px_40px_rgba(255,95,0,0.4)]">
                  Découvrir nos solutions <span className="text-xl">→</span>
                </a>
              </div>
            </div>
            <div className="hidden md:block absolute bottom-7 right-7 bg-white/95 text-[#00204E] rounded-2xl p-5 w-[280px] shadow-[0_20px_50px_rgba(0,32,78,0.2)] backdrop-blur-sm border border-white/30" style={{ animation: 'badgeFadeIn 1s ease 1.1s forwards', opacity: 0 }}>
              <p className="text-sm leading-relaxed font-semibold m-0"><span className="inline-block text-[#FF5F00] mr-2">📊</span>Diagnostic gratuit : Révélateur de vos leviers de croissance IA</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="savoir" className="py-25 px-5 bg-[#F9FAFB]">
        <div className="max-w-[1200px] mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-12 max-w-[800px] mx-auto">Des fondations data robustes, des cas d'usage IA concrets, et une expertise ancrée dans l'industrie.</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-15">
            {[
              { icon: '📅', title: 'Approche progressive', desc: 'Des solutions adaptées à votre maturité data, pour avancer vite et bien, sans surinvestissement.', img: 'https://images.unsplash.com/photo-1555949963-ff9fe0c870eb?q=80&w=1600&auto=format&fit=crop' },
              { icon: '⚙️', title: 'Solutions pragmatiques', desc: 'Des cas d\'usage IA concrets et mesurables, pensés pour vos contraintes opérationnelles.', img: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=1600&auto=format&fit=crop' },
              { icon: '🏭', title: 'Expertise sectorielle', desc: 'Une connaissance fine des enjeux de la métallurgie, plasturgie, agroalimentaire et mécanique.', img: 'https://images.unsplash.com/photo-1581092921461-eab62e97a780?q=80&w=1600&auto=format&fit=crop' }
            ].map((item, i) => (
      ...
      <section id="offers" className="py-25 px-5 bg-gradient-to-br from-[#F9FAFB] to-[#E8F4FD]">
        <div className="max-w-[1200px] mx-auto text-center">
          <h2 className="text-3xl md:text-4xl text-[#00204E] mb-5 uppercase tracking-wider font-bold">Nos offres</h2>
          <p className="text-lg md:text-xl text-gray-600 mb-12 max-w-[800px] mx-auto">Trois niveaux d'intervention adaptés à votre maturité data et à vos objectifs business.</p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-15">
            {[
              { title: 'Data First', desc: 'Structurez et fiabilisez vos données pour créer des fondations solides.', features: ['Diagnostic de maturité data', 'Cartographie des données', 'Quick wins opérationnels'], featured: false },
              { title: 'IA Ready', desc: 'Déployez des cas d\'usage IA simples et à forte valeur ajoutée.', features: ['Identification des cas d\'usage', 'Développement de MVP', 'Accompagnement au déploiement'], featured: true },
              { title: 'IA Clarity', desc: 'Clarifiez vos priorités IA et construisez votre feuille de route.', features: ['Conseil stratégique', 'Priorisation des initiatives', 'Feuille de route détaillée'], featured: false }
            ].map((offer, i) => (
              <div key={i} className={`bg-white rounded-3xl overflow-hidden shadow-[0_20px_50px_rgba(0,32,78,0.1)] transition-all duration-300 hover:-translate-y-4 hover:shadow-[0_30px_70px_rgba(0,32,78,0.2)] ${offer.featured ? 'md:scale-105 border-2 border-[#FF5F00]' : ''}`}>
                <div className={`p-10 text-center relative ${offer.featured ? 'bg-gradient-to-br from-[#FF5F00] to-[#e55100]' : 'bg-gradient-to-br from-[#00204E] to-[#003875]'}`}>
                  {offer.featured && <div className="absolute top-4 right-4 bg-white text-[#FF5F00] px-4 py-2 rounded-full text-xs font-bold uppercase tracking-wide">Populaire</div>}
                  <h3 className="text-white text-2xl md:text-3xl font-bold m-0">{offer.title}</h3>
                </div>
                <div className="p-8 border-b border-gray-100"><p className="text-base md:text-lg text-gray-600 leading-relaxed">{offer.desc}</p></div>
                <ul className="p-8 space-y-5">
                  {offer.features.map((feature, j) => (
                    <li key={j} className="flex items-center text-left text-gray-700"><span className="text-[#FF5F00] mr-4 text-xl">✓</span><span className="text-base">{feature}</span></li>
                  ))}
                </ul>
                <div className="p-8 pt-0">
                  <button className="w-full py-4 bg-gradient-to-br from-[#FF5F00] to-[#e55100] text-white rounded-xl font-bold uppercase tracking-wide transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10px_25px_rgba(255,95,0,0.3)]">En savoir plus</button>
                </div>
              </div>
            ))}
          </div>
      ...
      <section id="sectors" className="py-25 px-5 bg-white">
        <div className="max-w-[1200px] mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-600 mb-12 max-w-[800px] mx-auto">Des solutions adaptées aux spécificités de votre industrie.</p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mt-15 mb-15">
            {[
              { icon: '🏭', title: 'Métallurgie', desc: 'Optimisation des processus, maintenance prédictive, contrôle qualité.' },
              { icon: '♻️', title: 'Plasturgie', desc: 'Réduction des rebuts, optimisation des paramètres, traçabilité.' },
              { icon: '🌱', title: 'Agroalimentaire', desc: 'Sécurité alimentaire, optimisation des recettes, gestion de la chaîne du froid.' },
              { icon: '⚙️', title: 'Mécanique', desc: 'Optimisation des processus d\'usinage, contrôle qualité, planification.' }
            ].map((sector, i) => (
          ...
          <button className="px-10 py-4 bg-gradient-to-br from-[#00204E] to-[#003875] text-white rounded-full font-bold text-base md:text-lg uppercase tracking-wide transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_15px_35px_rgba(0,32,78,0.3)]">Découvrir tous nos secteurs d'expertise</button>
        </div>
      </section>

      <section className="py-25 px-5 bg-gradient-to-br from-[#F9FAFB] to-[#F0F8FF]">
        <div className="max-w-[1200px] mx-auto text-center">
          <h2 className="text-3xl md:text-4xl text-[#00204E] mb-5 uppercase tracking-wider font-bold">Ce Que Nos Clients Disent</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-15">
            {[
              { quote: "VIAKDATA a révolutionné notre approche data et nous a fait gagner 40% d'efficacité sur nos processus de production.", author: 'Marie Dupont', title: 'Directrice Technique, IndustrieTech' },
              { quote: "Une expertise IA remarquable adaptée à nos besoins industriels. L'équipe comprend vraiment nos enjeux métier.", author: 'Pierre Martin', title: 'CEO, Manufacturing Solutions' },
              { quote: "Leur approche méthodique a transformé nos données en véritable mine d'or. ROI visible dès les premiers mois.", author: 'Sophie Leroy', title: 'Responsable Data, TechnoPlus' }
            ].map((t, i) => (
      ...
      <section id="contact" className="py-30 px-5 bg-gradient-to-br from-[#f8fafc] via-[#e2e8f0] to-[#cbd5e1] text-center relative overflow-hidden">
        <div className="max-w-[1200px] mx-auto relative z-10">
          <h2 className="text-3xl md:text-4xl font-extrabold mb-8 text-[#00204E]">Prêt à transformer vos données en décisions ?</h2>
          <p className="text-lg md:text-xl leading-relaxed mb-12 text-gray-600 max-w-[800px] mx-auto">
            Contactez-nous dès aujourd'hui pour un diagnostic gratuit de votre maturité data et découvrez comment VIAKDATA peut vous accompagner dans votre transformation digitale.
          </p>
        ...
        <div className="max-w-[1200px] mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            <div>
              ...
              <p className="text-white/80 leading-relaxed mb-8">Accompagnement des PME industrielles françaises dans leur transformation digitale et IA.</p>
            ...
            <div>
              <h3 className="text-lg font-bold text-[#FF5F00] uppercase tracking-wide mb-6 relative after:absolute after:bottom-[-8px] after:left-0 after:w-10 after:h-0.5 after:bg-[#FF5F00]">Nos Services</h3>
              <ul className="space-y-4">
                <li><a href="#offers" className="text-white/80 hover:text-[#FF5F00] transition-all duration-300 hover:translate-x-1 inline-block">Data First</a></li>
                <li><a href="#offers" className="text-white/80 hover:text-[#FF5F00] transition-all duration-300 hover:translate-x-1 inline-block">IA Ready</a></li>
                <li><a href="#offers" className="text-white/80 hover:text-[#FF5F00] transition-all duration-300 hover:translate-x-1 inline-block">IA Clarity</a></li>
                <li><a href="#" className="text-white/80 hover:text-[#FF5F00] transition-all duration-300 hover:translate-x-1 inline-block">Formation</a></li>
              </ul>
            </div>
            <div>
