        ...
        <div className="max-w-[1400px] mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-15">
            {[
              ...
              <div key={i} className="solution-card bg-white rounded-3xl overflow-hidden shadow-[0_20px_50px_rgba(0,32,78,0.1)] transition-all duration-500 hover:-translate-y-4 hover:shadow-[0_35px_80px_rgba(0,32,78,0.25)] flex flex-col group relative">
                ...
                <div className="p-8 text-center flex-grow relative z-10">
                  <div className="solution-icon w-[80px] h-[80px] mx-auto mb-6 rounded-full bg-gradient-to-br from-[#0066CC] to-[#0052A3] flex items-center justify-center text-white text-3xl shadow-[0_10px_30px_rgba(0,32,78,0.12)] transition-all duration-500 group-hover:scale-110 group-hover:rotate-12 group-hover:from-[#FF5F00] group-hover:to-[#e55100] group-hover:shadow-[0_15px_40px_rgba(255,95,0,0.35)]">{offer.icon}</div>
