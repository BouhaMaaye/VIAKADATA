...
const ViakdataWebsite = () => {
  ...
  return (
    <div className="font-sans bg-[#F9FAFB] text-gray-800 overflow-x-hidden">
      ...
      {showIntro && (
        <div className="fixed inset-0 bg-gradient-to-br from-[#00204E] via-[#001739] to-[#000f26] z-[9999] flex items-center justify-center overflow-hidden" style={{ animation: 'introFadeOut 0.6s ease forwards 0.9s' }}>
          <iframe 
            src='https://my.spline.design/claritystream-2crDdC3pZ2UPWQqCuAWJyJj5/' 
            frameBorder='0' 
            width='100%' 
            height='100%'
            className="absolute inset-0"
            title="VIAKDATA 3D Animation"
          />
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <div className="text-center" style={{ animation: 'introRise 0.9s cubic-bezier(0.22,0.61,0.36,1) 0.2s forwards', transform: 'translateY(10px)', opacity: 0 }}>
              <div className="font-extrabold text-[42px] text-white tracking-tight drop-shadow-[0_4px_20px_rgba(0,32,78,0.8)]">
      ...
      <section id="offers" className="py-25 px-5 bg-gradient-to-br from-[#F9FAFB] to-[#E8F4FD]">
        <div className="max-w-[1200px] mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-15">
            {[
              { title: 'Conseil & Audit Data', desc: 'Diagnostic complet de votre organisation data, identification des opportunités et définition de votre stratégie digitale.', features: ['Audit systèmes d\'information', 'Cartographie des flux de données', 'Roadmap de transformation'], featured: false },
              { title: 'Développement IA', desc: 'Conception et déploiement de solutions intelligentes adaptées à vos enjeux métiers et processus industriels.', features: ['Applications prédictives sur mesure', 'Automatisation intelligente', 'Intégration dans vos systèmes'], featured: true },
              { title: 'Formation & Accompagnement', desc: 'Transfert de compétences pour rendre vos équipes autonomes sur les technologies data et IA.', features: ['Formations méthodologiques', 'Ateliers pratiques terrain', 'Coaching équipes techniques'], featured: false }
            ].map((offer, i) => (
