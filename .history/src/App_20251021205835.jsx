        ...
        <div className="max-w-[1400px] mx-auto text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mt-15">
            {[
              ...
              <div key={i} className="bg-white rounded-3xl overflow-hidden shadow-[0_20px_50px_rgba(0,32,78,0.1)] transition-all duration-300 hover:-translate-y-4 hover:shadow-[0_30px_70px_rgba(0,32,78,0.2)] flex flex-col">
                <div className="p-8 text-center flex-grow">
                  <div className="w-[80px] h-[80px] mx-auto mb-6 rounded-full bg-gradient-to-br from-[#0066CC] to-[#0052A3] flex items-center justify-center text-white text-3xl shadow-[0_10px_30px_rgba(0,32,78,0.12)]">{offer.icon}</div>
                  <h3 className="text-xl md:text-2xl text-[#00204E] mb-5 font-bold">{offer.title}</h3>
                  <p className="text-base text-gray-600 leading-relaxed">{offer.desc}</p>
                </div>
                <div className="p-8 pt-0">
                  <button className="w-full py-4 bg-transparent border-2 border-[#0066CC] text-[#0066CC] rounded-xl font-bold uppercase tracking-wide transition-all duration-300 hover:bg-[#0066CC] hover:text-white hover:-translate-y-1 hover:shadow-[0_10px_25px_rgba(0,102,204,0.3)]">EN SAVOIR PLUS</button>
                </div>
              </div>
            ))}
          </div>
